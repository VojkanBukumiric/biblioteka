...
<body data-gr-c-s-loaded="true">
  ...
  <form:form class="horizontal"
    ...
    <div class="form-group row">
            <form:label path="ime"
										class="col-sm-3 col-form-label">Ime</form:label>
            <div class="col-sm-8">
          ...
          <div class="form-group row">
           ...
           <div class="col-sm-8">
            <form:input type="text" path="email" id="emailId"
											class="form-control" />
           <div> <form:errors path="email" cssClass="alert-danger" />
										</div>
         </div>
       </div>
             <div class="form-group row">
           <form:label class="col-sm-3 col-form-label" path="brClanskeKarte">Clanski broj</form:label>
           <div class="col-sm-8">
            <form:input type="text" path="brClanskeKarte" id="brClanskeKarteId"
											class="form-control" />
           <div> <form:errors path="brClanskeKarte"
												cssClass="alert-danger" />
										</div>
         </div>
       </div>
           ...
           <div class="form-group row">
           <form:label  class="col-sm-3 col-form-label" path="pocetakPretplate">Pocetak pretplate</form:label>
           <div class="col-sm-8">
            <form:input type="date" path="pocetakPretplate" id="pocetakPretplateId" class="form-control"/>
           <div> <form:errors path="pocetakPretplate" cssClass="alert-danger" /></div>
         </div>
       </div>
        <div class="form-group row">
           <form:label  class="col-sm-3 col-form-label" path="krajPretplate">Kraj pretplate</form:label>
           <div class="col-sm-8">
            <form:input type="date" path="krajPretplate" id="krajPretplateId" class="form-control"/>
           <div> <form:errors path="krajPretplate" cssClass="alert-danger" /></div>
         </div>
       </div>
