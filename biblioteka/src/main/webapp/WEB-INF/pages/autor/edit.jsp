	...
	<div class="container">
		<div class="row">
			<div class="col-md-7 offset-3">
				...
				<div class="card mb-4">
					<div class="card-body">
						<h2 class="card-title">izmeni autora</h2>

						<form:form class="form-horizontal"
							action="${pageContext.request.contextPath}/autor/update"
							...
							<form:hidden path="id"
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<form:input type="text" path="prezime"
											class="form-control" id="prezimeId" />
										<div>
								...
								<div class="form-group row">
									<form:label path="knjizevnaVrsta" class="col-sm-3 col-form-label">Knjizevna Vrsta</form:label>
									<div class="col-sm-8">
